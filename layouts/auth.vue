<template>
    <div class="flex min-h-screen">
        ...
        >
            ...
            <NuxtLink to="/" class="absolute top-8 left-8 flex items-center gap-2">
                <svg
                ...
                <span class="text-lg font-bold">Travel Log</span>
            </NuxtLink>
        ...
        <div class="relative hidden flex-1 lg:block">
            ...
            <!-- Gradient overlay -->
            <div
                class="absolute inset-0 bg-gradient-to-br from-black/60 via-black/30 to-emerald-900/40"
            />
            ...
            <div class="absolute inset-0 flex flex-col items-start justify-end p-16">
                <div class="max-w-md">
                    ...
                    <h2 class="mb-3 text-4xl leading-tight font-bold text-white">
                        Discover The World,<br />
                        <span class="text-emerald-400">One Journey</span> At a Time
                    </h2>
                    <p class="text-base leading-relaxed text-white/60">
                        Pin your memories on the map, log your adventures, and revisit every place
                    ...
                    <div class="mt-8 flex gap-8 border-t border-white/10 pt-6">
                        <div>
                            <p class="text-2xl font-bold text-white">195+</p>
                            <p class="mt-0.5 text-xs text-white/50">Countries</p>
                        </div>
                        <div>
                            <p class="text-2xl font-bold text-white">∞</p>
                            <p class="mt-0.5 text-xs text-white/50">Memories</p>
                        </div>
                        <div>
                            <p class="text-2xl font-bold text-white">1</p>
                            <p class="mt-0.5 text-xs text-white/50">Map for life</p>
                        </div>
                    </div>
                </div>
            </div>
